# Runs all 89 questions through the real chatbot pipeline (get_answer).
# Outputs: answers_for_sheet.csv (paste into Google Sheet) and retrieval_metrics.csv.
# Usage: python evaluate_retrieval.py [--k 5]
