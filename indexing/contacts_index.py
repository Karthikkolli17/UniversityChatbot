...
# Builds a natural-language passage optimised for dense retrieval.
# Phrasing mirrors student queries: "how do I contact", "who handles", "where is the office for".
...
if __name__ == "__main__":
    ...
    data = pd.read_csv(_root / "data" / "contacts_data.csv", dtype=str)
    data = data.fillna("")
