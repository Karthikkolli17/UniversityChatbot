...
# Outputs: JSON (term, event_date, event_name, source_url) and Excel.
import json
import os
import re
...
# Reads the Excel output, applies classification, and writes JSON. Use after manual Excel edits.
def excel_to_json():
